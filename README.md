...
## Project Structure
    ...
    ├── webtestingdjapp_dev_27436  # Django project configurations
...
1. Clone this repo and `cd webtestingdjapp_dev_27436`
...
2. Clone this repo and `cd webtestingdjapp_dev_27436`
